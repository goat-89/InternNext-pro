-- Add user-facing notifications to admin moderation actions.
-- Run this after 202606240005_add_admin_moderation_audit_rpcs.sql.
...
begin
  ...
  values (
    updated_company.owner_id,
    'Company approved',
    updated_company.name || ' has been approved. You can now submit internships for review.',
    '/employer/settings'
  );
...
begin
  ...
  values (
    ...
    updated_company.name || ' needs changes before approval. Reason: ' || clean_reason,
    '/employer/settings'
  );
...
begin
  ...
  values (
    ...
    updated_company.name || ' has been returned to pending review.',
    '/employer/settings'
  );
...
begin
  ...
  values (
    updated_internship.employer_id,
    'Internship approved',
    updated_internship.title || ' is now approved and visible to eligible students.',
...
begin
  ...
  values (
    updated_internship.employer_id,
    'Internship changes requested',
    updated_internship.title || ' needs changes before approval. Reason: ' || clean_reason,
    '/employer/internships'
  );
...
begin
  ...
  values (
    ...
    case
      when p_account_status = 'suspended'
        then 'Your student account has been suspended. Contact support if you need help.'
      else 'Your student account has been reactivated.'
    end,
